function onCreatePost()
	...
	setTextSize('closedCaptionText',24)
	setTextBorder('closedCaptionText',0,'000000')
	setTextFont('closedCaptionText', 'pixel.otf')
	addLuaText('closedCaptionText')
	setObjectCamera('closedCaptionText','other')
	setTextBorder('closedCaptionText', 2, '000000')
...
function updateCaptionTextBG()
	setGraphicSize('closedCaptionBG',getProperty('closedCaptionText.text.length')*30 + 50,40,true)
